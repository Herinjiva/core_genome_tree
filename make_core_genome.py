...
def parseArguments():
    ...
    parser = argparse.ArgumentParser(description = 'command line example: python make_core_genome.py C:/Users/jean-/OneDrive/Documents/Ndijva/dothideomycetes/Blast_output/ dothideomycetes C:/Users/jean-/OneDrive/Documents/Ndijva/')
    ...
    parser.add_argument("output", help="absolute or relative path to the outfile directory (3 .json files created)", type=str)
